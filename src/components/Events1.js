                  ...
                  <div class="blog-item bg-light rounded overflow-hidden">
                    ...
                    <div class="p-4">
                      <div class="d-flex mb-3">
                        <small class="me-3">
                          <i class="far fa-user text-primary me-2"></i>Dr. G
                          Somashekar
                        </small>
                        <small>
                          <i class="far fa-calendar-alt text-primary me-2"></i>7
                          june, 2020
                        </small>
                      </div>
                ...
                <div class="col-md-6 wow slideInUp" data-wow-delay="0.1s">
                  <div class="blog-item bg-light rounded overflow-hidden">
                    ...
                    <div class="p-4">
                      <div class="d-flex mb-3">
                        <small class="me-3">
                          <i class="far fa-user text-primary me-2"></i>Dr.G Soma
                          Sekhar
                        </small>
                        <small>
                          <i class="far fa-calendar-alt text-primary me-2"></i>
                ...
                <div class="col-md-6 wow slideInUp" data-wow-delay="0.6s">
                  <div class="blog-item bg-light rounded overflow-hidden">
                    ...
                    <div class="p-4">
                      <div class="d-flex mb-3">
                        <small class="me-3">
                          <i class="far fa-user text-primary me-2"></i>B.John
                          Benedict
                        </small>
                        <small>
                          <i class="far fa-calendar-alt text-primary me-2"></i>5
                          july, 2020
                        </small>
                      </div>
                      <h4 class="mb-3">
                        Management Lessons from running a student branch{" "}
                      </h4>
                ...
                <div class="col-md-6 wow slideInUp" data-wow-delay="0.1s">
                  <div class="blog-item bg-light rounded overflow-hidden">
                    ...
                    <div class="p-4">
                      <div class="d-flex mb-3">
                        <small class="me-3">
                          <i class="far fa-user text-primary me-2"></i>Karthik
                          ai Engineer{" "}
                        </small>
                        <small>
                          <i class="far fa-calendar-alt text-primary me-2"></i>
                      ...
                      <h4 class="mb-3">
                        Building End to End Machine Learning from Scratch
                      </h4>
