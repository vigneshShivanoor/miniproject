      ...
      <div className="container py-5">
        ...
        <div className="row g-0">
          <div className="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
            <div className="bg-light rounded">
              ...
              <div className="p-5 pt-0">
                ...
                <Link to="https://www.ieee.org/membership-catalog/productdetail/showProductDetailPage.html?product=MEMC016&searchResults=Y" className="btn btn-primary py-2 px-4 mt-4">Join Now</Link>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-4 wow slideInUp" data-wow-delay="0.9s">
            <div className="bg-light rounded">
              <div className="border-bottom py-4 px-5 mb-4">
                <h4 className="text-primary mb-1"> IEEE Communications Society </h4>
                <small className="text-uppercase">IEEE Data Port </small>
              </div>
              <div className="p-5 pt-0">
                <h1 className="display-5 mb-3">
                ...
                <div className="d-flex justify-content-between mb-3"><span>Non-IEEE Member</span>US $0.00</div>
                {/* <div className="d-flex justify-content-between mb-2"><span>Cross-browser Support</span></div> */}
                <Link to="https://www.comsoc.org/" className="btn btn-primary py-2 px-4 mt-4">JOIN IEEE</Link>
              </div>
            </div>
          </div>
        </div>
