...
export default function Event2023() {
  return (
    <>
      <>
        <Topbar />
                    ...
                    <div class="blog-item bg-light rounded overflow-hidden">
                      ...
                      <div class="p-4">
                        <div class="d-flex mb-3">
                          <small class="me-3">
                            <i class="far fa-user text-primary me-2"></i>P. sai
                            vardhan reddy
                          </small>
                          <small>
                  ...
                  <div class="col-md-6 wow slideInUp" data-wow-delay="0.1s">
                    <div class="blog-item bg-light rounded overflow-hidden">
                      ...
                      <div class="p-4">
                        <div class="d-flex mb-3">
                          <small class="me-3">
                            <i class="far fa-user text-primary me-2"></i>Dhanush
                          </small>
                          <small>
                            <i class="far fa-calendar-alt text-primary me-2"></i>
                            22 Apr, 2024
                        ...
                        <Link class="text-uppercase" to="/Chakravyuh">
                          Register here <i class="bi bi-arrow-right"></i>
                        </Link>
                      </div>
                    </div>
                  ...
                  <div class="col-md-6 wow slideInUp" data-wow-delay="0.1s">
                    <div class="blog-item bg-light rounded overflow-hidden">
                      ...
                      <div class="p-4">
                        ...
                        <p>
                          "CodeQuizz: ML Edition" is related to the field of
                          Machine Learning, an exciting event for enthusiasts of
                          this dynamic field.{" "}
                        </p>
                        <Link class="text-uppercase" to="/Codequizz">
                          Register Here <i class="bi bi-arrow-right"></i>
                        </Link>
                      </div>
                    </div>
                  ...
                  <div class="col-md-6 wow slideInUp" data-wow-delay="0.1s">
                    <div class="blog-item bg-light rounded overflow-hidden">
                      ...
                      <div class="p-4">
                        <div class="d-flex mb-3">
                          <small class="me-3">
                            <i class="far fa-user text-primary me-2"></i>Neha
                            Nandal
                          </small>
                          <small>
                            <i class="far fa-calendar-alt text-primary me-2"></i>
                        ...
                        <p>
                          International Level Coding all the students should
                          participate
                        </p>
                        <Link class="text-uppercase" to="/Ieeextreme">
                          Register Here <i class="bi bi-arrow-right"></i>
                        </Link>
                      </div>
                    </div>
