...
export default function Xecom1() {
  return (
    <>
      <Topbar />
      <div
          ...
          <div className="collapse navbar-collapse" id="navbarCollapse">
            <div className="navbar-nav ms-auto py-0">
              ...
              <div className="nav-item dropdown">
                <Link to="/Events" className="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                  Events
                </Link>
              ...
              <div className="nav-item dropdown">
                <Link to="/xecom" className="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                  Xecom
                </Link>
                <div className="dropdown-menu m-0">
                  <Link to="/Xecom" className="dropdown-item">
              ...
              <div className="nav-item dropdown">
                <Link to="index.html" className="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                  Pages
                </Link>
                <div className="dropdown-menu m-0">
            ...
            <Link to="https://htmlcodex.com/startup-company-website-template" className="btn btn-primary py-2 px-4 ms-3">
              Join IEEE
            </Link>
          </div>
        </nav>
        ...
        <div className="container-fluid bg-primary py-5 bg-header" style={{ marginBottom: '90px' }}>
          <div className="row py-5">
            <div className="col-12 pt-lg-5 mt-lg-5 text-center">
              ...
              <Link to="index.html" className="h5 text-white">
                Alumni OF IEEE SB year of 2024
              </Link>
            </div>
          </div>
        </div>
      ...
      <div style={mainContainerStyle}>
        ...
        <div style={profileCardStyle}>
          ...
          <p>Chair</p>
          <Link to="mailto:email@example.com" style={profileLinkStyle}>
            Email
          </Link>
          <Link to="https://linkedin.com/in/username" style={profileLinkStyle}>
            LinkedIn
          </Link>
        </div>
        <div style={profileCardStyle}>
